    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center border rounded p-0 shadow">
            <div class="col-12 col-md-6">
                ...
                <p>Cosa farai: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae, temporibus.</p>
                <h2>Lavora come redattore</h2>
                <p>Cosa farai: Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, dignissimos.</p>
            </div>
            <div class="col-12 col-md-6">
                @if($errors->any())
